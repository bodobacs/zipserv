...
struct chmPmglHeader
{
    ...
    unsigned int      free_space;       /*  4 UInt32 */
    unsigned int      unknown_0008;           /*  8 UInt32 */
    int       block_prev;             /*  c Int32 */
    int       block_next;             /* 10 Int32 */
...
struct chm_list_rundata
{
    ...
    /* RWE 6/12/2003 */
    unsigned char *page_buf; //UChar
    struct chmPmglHeader header;
    unsigned char *end;	//UChar
    unsigned char *cur; //UChar
    unsigned int lenRemain; //UChar
    unsigned long ui_path_len; //UInt64 
